...
class MessagingWssDurableDisconnectRetryTest {
    @Test
    fun authenticatedDisconnectWithInflightSendPreservesDurableBackoffAcrossReauth() {
        val fixture = Fixture()
        val encodedEnvelope = MessagingWire.encodeEnvelope(outboundEnvelope())
    ...
    @Test
    fun authenticatedNetworkFailureWithInflightSendUsesDurableRetryPath() {
        val fixture = Fixture()
        fixture.recovery.plan = MessagingRecoveryPlan(
            outboundSends = listOf(
                MessagingRecoveredSend(
    ...
    private class FakeSocket(
        ...
        fun networkFailure() = listener.onFailure(this, IllegalStateException("network"))
    }
